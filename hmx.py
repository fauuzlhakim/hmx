...
_SYNC_NAMES = [
    ...
    'DEFAULT_PROVIDER', 'BASE_URL', 'LEGACY_REGISTRY', 'LEGACY_HOMES', 'HERMES_REPO_PATH',
    'HERMES_RUN_AGENT_PATH', 'HERMES_AUTH_MODULE_PATH', 'HMX_BIN_PATH', 'HMX_DEFAULT_SOURCE_PATH',
    ...
    'verify_run_agent_compile', 'verify_auth_module_compile', 'repair_live_auth_from_registry',
    'ensure_hmx_entrypoint_wrapper', 'run_codex_rotation_smoke_test', 'cmd_patch_hermes', 'cmd_smoke',
...
for _module, _names in [
    ...
    (_hermes_patch, ['patch_run_agent', 'patch_auth_store_symlink_preservation', 'unpatch_run_agent', 'describe_run_agent_patch', 'verify_run_agent_compile', 'verify_auth_module_compile', 'ensure_hmx_entrypoint_wrapper', 'run_codex_rotation_smoke_test']),
